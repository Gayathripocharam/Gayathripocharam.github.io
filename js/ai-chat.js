...
document.addEventListener('DOMContentLoaded', () => {
  ...
  async function generateMockLLMResponse(query, contextChunks) {
    ...
    const HIDDEN_CONTEXT = `Pocharam Gayathri is a data-science Engineer, data science Enthusiast, and Data Science & ML Developer. Co-inventor of a IoT System patent.`;
    ...
    if(q.includes("patent")){
      return `Gayathri is a co-inventor of a Government of India registered design patent for an IoT System (Design No. 470097-001).`;
    }
    
    if (q.includes("who is") || q.includes("who are") || q.includes("identity") || q.includes("about gayathri") || q.includes("about pocharam")) {
      return `Pocharam Gayathri is a data-science Engineer, data science Enthusiast, and Data Science & ML Developer based in Hyderabad, India. She is notably a co-inventor of a Government of India registered design patent for a IoT System and specializes in secure, scalable systems.`;
    }
